...
import com.android.kitsune.ui.backup.BackupSettingsActivity;
...
public class SettingsFragment extends Fragment implements
    ...
    // ── BACKUP ──
    private TextView textLastBackupSummary;
    ...
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        ...
        backupManager = BackupManager.getInstance(requireContext());
        ...
        textLastBackupSummary = view.findViewById(R.id.textLastBackupSummary);
    ...
    private void setupClickListeners(View view) {
        ...
        // Fitur Backup
        View layoutBackup = view.findViewById(R.id.layoutBackup);
        if (layoutBackup != null) {
            layoutBackup.setOnClickListener(v -> openBackupSettings());
        }
    ...
    private void updateBackupSummary() {
        if (textLastBackupSummary == null) return;
        String summary = backupManager.getLastBackupDisplayText();
        textLastBackupSummary.setText(getString(R.string.backup_subtitle_last, summary));
    }
